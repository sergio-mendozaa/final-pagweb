      ...
      <div className="menu">
        ...
        <div className="menu-image-container">
          <div className="image active">
            <img
              src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1687022201/adi-goldstein-EUsVwEOsblE-unsplash_2_pvbiyk.jpg"
              alt="Food Photo"
            />
          </div>
          <div className="image">
            <img
              src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1687021116/towfiqu-barbhuiya-joqWSI9u_XM-unsplash_1_cjgmgb.jpg"
              alt="Food Photo"
            />
          </div>
          <div className="image">
            <img
              src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1687191115/shubham-dhage-UxDU0Gg5pqQ-unsplash_1_xu1asz.jpg"
              alt="Food Photo"
              style={{ height: "92%" }}
            />
          </div>
          <div className="image">
            <img
              src="https://res.cloudinary.com/dwkb2dk5r/image/upload/v1687021549/kevin-ku-w7ZyuGYNpRQ-unsplash_1_bidjuc.jpg"
              alt="Food Photo"
              style={{ height: "92%", width: "15cm" }}
            />
          </div>
        </div>
